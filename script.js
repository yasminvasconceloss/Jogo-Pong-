...
function iniciarJogo() {
    ...
    velocidadeBola = 20;    //aumentou a velocidade da bola// 
    pontosJogador = 0;
    pontosOponente = 0;
...
function loopGame() {
   ...
   context.fillRect(oponentePosX, oponentePosY, barraWidth, barraHeigth); // desenha ooponente
   ...
   context.fill();
    ...
    /****************************** PLACAR *****************************/  
    var pontosA = pontosJogador; // variáveis temporarias para alterar pontuação
    ...
    context.font = "50pt Garamond"; // tamanho e fonte
    context.fillStyle = "#52CAEE"; //Seleciona a cor
